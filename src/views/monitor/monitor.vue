<!--<template>
  <div class="app-container calendar-list-container">
    <div style="width:33%;float:left;">
      <el-table :key='tableKey' :data="deviceList" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
                style="width: 100%">
        &lt;!&ndash; <el-table :data="list" row-key="id"  v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">&ndash;&gt;
        <el-table-column align="center" :label="$t('table.deviceName')" width="100">
          <template slot-scope="scope">
            <span><scg-icon icon-class="设备"></scg-icon></span>
          </template>
        </el-table-column>
...
<script>
  import { deployplanDevice } from '@/api/deployplan'
