<template>
  <div class="app-container calendar-list-container"
       ...
       style="position: absolute;top:80px;bottom:0;width:100%;height: 90%;"
  >
          ...
          <template slot-scope="props">
            <el-tabs>
              ...
              <el-tab-pane label="已修改">
                <el-table :data="props.row.modifyedFiles" fit>
                  <el-table-column label="文件名称" prop="name" min-width="240">
              ...
              <el-tab-pane label="已删除">
                <el-table :data="props.row.missingFiles" fit>
                  <el-table-column label="文件名称" prop="name" min-width="240">
                    <!--<template props="fileName">
                      &lt;!&ndash;<span>{{scope.row.deployPath}}</span>&ndash;&gt;
                    </template>-->
              ...
              <el-tab-pane label="未知">
                <el-table :data="props.row.unknownFiles" fit>
                  <el-table-column label="文件名称" prop="name" min-width="240">
                    <!--<template props="fileName">
                      &lt;!&ndash;<span>{{scope.row.deployPath}}</span>&ndash;&gt;
                    </template>-->
